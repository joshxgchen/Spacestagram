...
function Option({
  ...
  const singleSelectClassName = css.classNames(Option$1['default'].SingleSelectOption, focused && Option$1['default'].focused, disabled && Option$1['default'].disabled, select && Option$1['default'].select, active && Option$1['default'].active);
  const multiSelectClassName = css.classNames(Option$1['default'].Label, disabled && Option$1['default'].disabled, active && Option$1['default'].active, select && Option$1['default'].select);
