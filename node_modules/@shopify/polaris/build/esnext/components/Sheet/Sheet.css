.Polaris-Sheet_310da { position: fixed; bottom: 0; width: 100%; height: 100%; background-color: var(--p-surface); box-shadow: var(--p-modal-shadow); }

@media screen and (-ms-high-contrast: active) { .Polaris-Sheet_310da { border-left: 0.1rem solid var(--p-border-subdued); } }
...
.Polaris-Sheet__Bottom_o943l { -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: transform; transition: transform 300ms cubic-bezier(0.25, 0.1, 0.25, 1); transform-origin: bottom; }
...
.Polaris-Sheet__Right_312we { -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: transform; transition: transform 300ms cubic-bezier(0.25, 0.1, 0.25, 1); transform-origin: right; }
