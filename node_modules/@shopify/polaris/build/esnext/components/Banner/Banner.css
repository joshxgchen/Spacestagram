...
.Polaris-Banner__SecondaryAction_1dl4i:hover > .Polaris-Banner__Text_yj3uv { box-shadow: 0 -0.2rem 0 0 rgba(var(--p-rgb-text), 0.75) inset; }

.Polaris-Banner__SecondaryAction_1dl4i:active > .Polaris-Banner__Text_yj3uv { box-shadow: 0 -0.2rem 0 0 rgba(var(--p-rgb-text), 0) inset; }

.Polaris-Banner__SecondaryAction_1dl4i:focus > .Polaris-Banner__Text_yj3uv { padding: 0.2rem 0.5rem; margin: -0.2rem -0.5rem; background: var(--p-action-secondary-hovered); border-radius: 0.3rem; box-shadow: none; }

@media (-ms-high-contrast: active) { .Polaris-Banner__SecondaryAction_1dl4i:focus > .Polaris-Banner__Text_yj3uv { outline: 0.2rem dotted; } }

.Polaris-Banner__Text_yj3uv { box-shadow: 0 -0.2rem 0 0 rgba(var(--p-rgb-text), 0.25) inset; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: box-shadow; transition: box-shadow 200ms cubic-bezier(0.25, 0.1, 0.25, 1); }
...
@media (-ms-high-contrast: active) { .Polaris-Banner__Button_r99lw { border: 0.1rem solid windowText; } }
